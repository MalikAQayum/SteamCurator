...
function cChart_v1() {
    ...
    if(GM.getValue("aAppids") !== null){
        ...
        gdata.push(GM.getValue("peCopies"));
        gdata.push(GM.getValue("UniqueAppids"));
        gdata.push(GM.getValue("pAppids"));
        gdata.push(GM.getValue("eAppids"));
        gdata.push(GM.getValue("aAppids"));
    }else{
        glabels.push("Total Copies");
        glabels.push("Total Appids");
        glabels.push("Pending");
